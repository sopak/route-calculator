...
public class DijkstraRouteCalculatorServiceTest extends RouteCalculatorServiceTestBase {
    ...
    public static Collection<RouteRecord> classes() {
        return ImmutableList.of(
                ...
                new RouteRecord("ESP", "CZE", new Route(ImmutableList.of("ESP", "FRA", "DEU", "CZE"))),
                new RouteRecord("CZE", "ESP", new Route(ImmutableList.of("CZE", "DEU", "FRA", "ESP")))
        );
    }

    @BeforeClass
    public static void setUpProperty() {
        System.setProperty(RouteCalculatorService.PROPERTY_PREFIX + "." + RouteCalculatorService.PROPERTY_ALGORITHM_NAME, "dijkstra");
    }
}
